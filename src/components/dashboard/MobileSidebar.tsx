...
import { ChevronDown, Grid, Home, Package, ShoppingBag, Users, FileText, Calendar, Menu } from "lucide-react";
...
const MobileSidebar: React.FC = () => {
  ...
  const sidebarContent = (
    <div className="py-4 h-full overflow-y-auto">
      ...
      <div className="px-3 mb-2 mt-4 text-xs font-medium text-muted-foreground uppercase">Menu</div>
